...
- `agent4_lead_qualifier/` - Telegram-бот квалификации лидов (разговорная анкета из 6 критериев, запись в Google Sheets, реф-ссылка по завершении).
...
# Агент 4: телеграм-бот квалификации (Ctrl+C чтобы остановить)
